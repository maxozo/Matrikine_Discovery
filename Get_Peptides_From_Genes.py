        ...
        try:
            ...
            for each_second_entry in range(each+1,len(input)):
                try:
                    ...
                    if peptide_length>3 and peptide_length<8:
...
Protein_info = pd.read_csv('bin/Summary_MSP_E.csv', index_col=False, tupleize_cols=False)
...
for The_protein_gene_name_to_search_for in protein_gene_name :
    print "Analysing: "+The_protein_gene_name_to_search_for
